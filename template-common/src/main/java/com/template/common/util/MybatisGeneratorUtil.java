...
import static com.template.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
    ...
    public static void generator(
        ...
        String targetProject = proj + "/" + module + "-dao";
        ...
        try {
            ...
            context.put("generator_sqlMapGenerator_targetPackage", package_name + ".dao.xml");
            ...
            deleteDir(new File(targetProject + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/dao/xml"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        String servicePath = basePath + proj + "/" + module + "-api" + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/api";
        String serviceImplPath = basePath + proj + "/" + module + "-service" + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/service/impl";
